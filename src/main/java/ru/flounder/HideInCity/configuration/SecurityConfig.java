package ru.flounder.HideInCity.configuration;
...
import ru.flounder.HideInCity.security.TokenFilter;
import ru.flounder.HideInCity.services.UserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/unautorized/**").permitAll()
